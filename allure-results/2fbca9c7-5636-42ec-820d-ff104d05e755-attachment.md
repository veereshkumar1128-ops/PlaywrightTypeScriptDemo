...
Call log:
  - waiting for getByRole('link', { name: 'API testing by testers talk' }).first()
    - waiting for" https://www.google.com/search?q=API+testing+by+testers+talk&sca_esv=55e9f3c856495c1e&source=hp&ei=EKTfacitK9anqtsP0cmMqQc&iflsig=AFdpzrgAAAAAad-yIJslVqZs5m0c26zoItD4BeYw0UZg&ved=0ahUKEwjI9b_pi_CTAxXW…" navigation to finish...
    - navigated to "https://www.google.com/sorry/index?continue=https://www.google.com/search%3Fq%3DAPI%2Btesting%2Bby%2Btesters%2Btalk%26sca_esv%3D55e9f3c856495c1e%26source%3Dhp%26ei%3DEKTfacitK9anqtsP0cmMqQc%26iflsig%…"
...
- generic [ref=e2]:
  ...
  - iframe [ref=e8]:
    - generic [ref=f37e2]:
      - generic [ref=f37e3]:
        - checkbox "I'm not a robot" [ref=f37e7]
        - generic [ref=f37e11]: I'm not a robot
      - generic [ref=f37e15]: reCAPTCHA
  - separator [ref=e9]
  - generic [ref=e10]:
    ...
    - generic [ref=e12]:
      ...
      - text: "Time: 2026-04-15T14:43:32Z"
      - text: "URL: https://www.google.com/search?q=API+testing+by+testers+talk&sca_esv=55e9f3c856495c1e&source=hp&ei=EKTfacitK9anqtsP0cmMqQc&iflsig=AFdpzrgAAAAAad-yIJslVqZs5m0c26zoItD4BeYw0UZg&ved=0ahUKEwjI9b_pi_CTAxXWk2oFHdEkI3UQ4dUDCBY&uact=5&oq=API+testing+by+testers+talk&gs_lp=Egdnd3Mtd2l6IhtBUEkgdGVzdGluZyBieSB0ZXN0ZXJzIHRhbGtIFFAAWABwAHgAkAEAmAEAoAEAqgEAuAEDyAEA-AEBmAIAoAIAmAMAkgcAoAcAsgcAuAcAwgcAyAcAgAgB&sclient=gws-wiz&sei=EqTfaducHuiK5OUP_vPb2As"
```
